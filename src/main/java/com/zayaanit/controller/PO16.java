		...
		if(SubmitFor.INSERT.equals(pocrnheader.getSubmitFor())) {
			...
			eventPublisher.publishEvent(
					new XlogsdtEvent(
						...
						.xtable(null)
						.xdata(pocrnheader.getXcrnnum().toString())
						.xstatement("Add Data : " + pocrnheader.toString())
						.xresult("Success")
						.build(), 
						sessionManager
					)
		...
		if(SubmitFor.INSERT.equals(pocrndetail.getSubmitFor())) {
			...
			eventPublisher.publishEvent(
					new XlogsdtEvent(
						...
						.xtable(null)
						.xdata(pocrndetail.getXcrnnum().toString() + "/" + pocrndetail.getXrow())
						.xstatement("Add Detail Data : " + pocrndetail.toString())
						.xresult("Success")
						.build(), 
						sessionManager
					)
	...
	public @ResponseBody Map<String, Object> deleteDetail(@RequestParam Integer xcrnnum, @RequestParam Integer xrow){
		...
		eventPublisher.publishEvent(
				new XlogsdtEvent(
					...
					.xsource("PO16")
					.xtable(null)
					.xdata(obj.getXcrnnum().toString() + "/" + obj.getXrow())
