		...
		if(isAjaxRequest(request) && frommenu == null) {
			...
			eventPublisher.publishEvent(
					new XlogsdtEvent(
						...
						.xsource("FA31")
						.xtable(null)
						.xdata(potogli.getXtype() + "/" + potogli.getXgsup() + "/" + potogli.getXgitem())
						.xstatement("View Data : " + potogli.toString())
						.xresult("Success")
						.build(), 
						sessionManager
					)
	...
	public @ResponseBody Map<String, Object> store(Potogli potogli, BindingResult bindingResult){
		...
		if(SubmitFor.INSERT.equals(potogli.getSubmitFor())) {
			...
			eventPublisher.publishEvent(
					new XlogsdtEvent(
						...
						.xtable(null)
						.xdata(potogli.getXtype() + "/" + potogli.getXgsup() + "/" + potogli.getXgitem())
						.xstatement("Add Data : " + potogli.toString())
						.xresult("Success")
						.build(), 
						sessionManager
					)
		...
		eventPublisher.publishEvent(
				new XlogsdtEvent(
					...
					.xsource("FA31")
					.xtable(null)
					.xdata(existObj.getXtype() + "/" + existObj.getXgsup() + "/" + existObj.getXgitem())
