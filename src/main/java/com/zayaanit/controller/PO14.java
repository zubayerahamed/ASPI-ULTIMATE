...
import com.zayaanit.repo.PogrndetailRepo;
...
public class PO14 extends KitController {
			...
			if(pogrnheader != null) {
				eventPublisher.publishEvent(
						new XlogsdtEvent(
							...
							.xsource("PO14")
							.xtable(null)
							.xdata(pogrnheader.getXgrnnum().toString())
							.xstatement("View Data : " + pogrnheader.toString())
							.xresult("Success")
							.build(), 
							sessionManager
						)
	...
	public String detailFormFragment(@RequestParam String xgrnnum, @RequestParam String xrow, @RequestParam(required = false) Integer xitem, Model model) {
		...
		if(pogrndetail != null && pogrndetail.getXrow() != 0) {
			eventPublisher.publishEvent(
					new XlogsdtEvent(
						Xlogsdt.builder()
						.xscreen("PO14")
						...
						.xsource("PO14")
						.xtable(null)
						.xdata(pogrndetail.getXgrnnum().toString() + "/" + pogrndetail.getXrow())
						.xstatement("View Detail Data : " + pogrndetail.toString())
						.xresult("Success")
						.build(), 
						sessionManager
					)
	...
	public @ResponseBody Map<String, Object> store(Pogrnheader pogrnheader, BindingResult bindingResult){
		...
		if(SubmitFor.INSERT.equals(pogrnheader.getSubmitFor())) {
			...
			eventPublisher.publishEvent(
				new XlogsdtEvent(
						...
						.xtable(null)
						.xdata(pogrnheader.getXgrnnum().toString())
						.xstatement("Add Data : " + pogrnheader.toString())
						.xresult("Success")
						.build(), 
						sessionManager
					)
		...
		eventPublisher.publishEvent(
				new XlogsdtEvent(
						...
						.xsource("PO14")
						.xtable(null)
						.xdata(existObj.getXgrnnum().toString())
	...
	public @ResponseBody Map<String, Object> storeDetail(Pogrndetail pogrndetail, BindingResult bindingResult){
		...
		if(SubmitFor.INSERT.equals(pogrndetail.getSubmitFor())) {
			...
			eventPublisher.publishEvent(
					new XlogsdtEvent(
							...
							.xtable(null)
							.xdata(pogrndetail.getXgrnnum().toString() + "/" + pogrndetail.getXrow())
							.xstatement("Add Detail Data : " + pogrndetail.toString())
							.xresult("Success")
							.build(), 
							sessionManager
						)
			...
			eventPublisher.publishEvent(
					new XlogsdtEvent(
							...
							.xtable(null)
							.xdata(pogrnheader.getXgrnnum().toString())
							.xstatement("Update Data : " + pogrnheader.toString())
							.xresult("Success")
							.build(), 
							sessionManager
						)
		...
		eventPublisher.publishEvent(
				new XlogsdtEvent(
						...
						.xsource("PO14")
						.xtable(null)
						.xdata(exist.getXgrnnum().toString() + "/" + exist.getXrow())
	...
	public @ResponseBody Map<String, Object> delete(@RequestParam Integer xgrnnum){
		...
		eventPublisher.publishEvent(
				new XlogsdtEvent(
						...
						.xsource("PO14")
						.xtable(null)
						.xdata(op.get().getXgrnnum().toString())
		...
		eventPublisher.publishEvent(
				new XlogsdtEvent(
						...
						.xsource("PO14")
						.xtable(null)
						.xdata(copy.getXgrnnum().toString())
	...
	public @ResponseBody Map<String, Object> deleteDetail(@RequestParam Integer xgrnnum, @RequestParam Integer xrow){
		...
		eventPublisher.publishEvent(
				new XlogsdtEvent(
						...
						.xsource("PO14")
						.xtable(null)
						.xdata(obj.getXgrnnum().toString() + "/" + obj.getXrow())
...
//		}
		...
		eventPublisher.publishEvent(
				new XlogsdtEvent(
						...
						.xsource("PO14")
						.xtable(null)
						.xdata(xgrnnum.toString())
						.xstatement("Confirm GRN : PO_ConfirmGRN(" + sessionManager.getBusinessId() +","+ sessionManager.getLoggedInUserDetails().getUsername() +","+ xgrnnum +")")
						.xresult("Success")
						.build(), 
						sessionManager
					)
