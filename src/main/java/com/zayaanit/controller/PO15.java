...
import com.zayaanit.repo.PoorddetailRepo;
	...
	public @ResponseBody Map<String, Object> storeDetail(Pogrndetail pogrndetail, BindingResult bindingResult){
		...
		eventPublisher.publishEvent(
				new XlogsdtEvent(
					...
					.xsource("PO15")
					.xtable(null)
					.xdata(existObj.getXgrnnum().toString() + "/" + existObj.getXrow())
		...
		eventPublisher.publishEvent(
				new XlogsdtEvent(
					...
					.xsource("PO15")
					.xtable(null)
					.xdata(order.getXpornum().toString())
	...
	public @ResponseBody Map<String, Object> delete(@RequestParam Integer xgrnnum){
		...
		eventPublisher.publishEvent(
				new XlogsdtEvent(
					...
					.xstatement("Delete All Detail Data : " + xgrnnum)
					.xresult("Success")
					.build(), 
					sessionManager
				)
	...
	public @ResponseBody Map<String, Object> deleteDetail(@RequestParam Integer xgrnnum, @RequestParam Integer xrow){
		...
		eventPublisher.publishEvent(
				new XlogsdtEvent(
					...
					.xsource("PO15")
					.xtable(null)
					.xdata(xgrnnum.toString() + "/" + obj.getXrow())
	...
	public @ResponseBody Map<String, Object> confirm(@RequestParam Integer xgrnnum) {
		...
		eventPublisher.publishEvent(
				new XlogsdtEvent(
					...
					.xtable(null)
					.xdata(pogrnheader.getXgrnnum().toString())
					.xstatement("Confirm Data : PO_ConfirmGRN(" + sessionManager.getBusinessId() +","+ sessionManager.getLoggedInUserDetails().getUsername() +","+ xgrnnum +")")
					.xresult("Success")
					.build(), 
					sessionManager
				)
