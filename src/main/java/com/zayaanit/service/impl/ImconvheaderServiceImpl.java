...
@Service
public class ImconvheaderServiceImpl extends AbstractService implements ImconvheaderService {
	...
	private Imconvheader constractListOfXwhs(Map<String, Object> row) {
		Imconvheader em = new Imconvheader();
		em.setXconvnum((Integer) row.get("xconvnum"));
	...
	private StringBuilder whereClause(String searchText, int suffix, String dependentParam) {
		...
		return sql.append(" AND (im.xconvnum LIKE '%" + searchText + "%' "
