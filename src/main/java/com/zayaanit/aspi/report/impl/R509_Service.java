...
@Service(value = "R509_Service")
public class R509_Service extends AbstractReportService {
	...
	public List<FormFieldBuilder> getReportFields() {
		...
		fieldsList.add(FormFieldBuilder.generateDropdownField(6, "Item Category (FG)", itemCategory, "", false));

		fieldsList.add(FormFieldBuilder.generateAdvancedSearchField(7, "Item (FG)", "/search/table/LMD12/1?hint=", "", false));
