...
@Service(value = "R408_Service")
public class R408_Service extends AbstractReportService {
	...
	public List<FormFieldBuilder> getReportFields() {
		...
		status.add(new DropdownOption("Direct Invoice", "Direct Invoice"));
		status.add(new DropdownOption("POS Invoice", "POS Invoice"));
