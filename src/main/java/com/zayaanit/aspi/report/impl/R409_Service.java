...
@Service(value = "R409_Service")
public class R409_Service extends AbstractReportService {
	...
	public List<FormFieldBuilder> getReportFields() {
		...
		status.add(new DropdownOption("Invoice Created", "Invoice Created"));
		status.add(new DropdownOption("Full Delivered", "Full Delivered"));
		status.add(new DropdownOption("Invoice Created & Dismissed", "Invoice Created & Dismissed"));
