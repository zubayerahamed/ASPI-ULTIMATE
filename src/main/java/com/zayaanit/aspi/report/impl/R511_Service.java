...
@Service(value = "R511_Service")
public class R511_Service extends AbstractReportService {
	...
	public List<FormFieldBuilder> getReportFields() {
		...
		fieldsList.add(FormFieldBuilder.generateDropdownField(6, "Item Category (By Products)", itemCategory, "", false));

		fieldsList.add(FormFieldBuilder.generateAdvancedSearchField(7, "Item (By Products)", "/search/table/LMD12/1?hint=", "", false));
